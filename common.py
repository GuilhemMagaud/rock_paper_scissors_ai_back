...
# Ajoute ici toutes les autres fonctions utilitaires partagées (draw_landmarks, draw_bounding_rect, etc.)
# ... (copie les fonctions de app.py qui sont utilisées dans les deux modes)
